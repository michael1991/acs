...
-   通过控制台界面创建 NAS 数据卷
    ...
    3.  选择所需的集群，单击页面右上角的**创建**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6937/15349298714680_zh-CN.png)
    ...
    4.  在创建数据卷对话框中，配置数据卷的相关参数。
        ...
        -   **标签**：为该数据卷添加标签。
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6937/15349298714681_zh-CN.png)
...
**Note:** 创建的 NAS 文件系统需要和您的集群位于同一地域。
