...
3.  设置**应用名称**、**部署集群** 和 **命名空间**，并单击**下一步** 进入应用配置页面。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119074387_zh-CN.png)
...
4.  设置应用的基本配置。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119074388_zh-CN.png)
...
5.  设置容器的资源限制和资源预留。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119074389_zh-CN.png)
...
6.  配置数据卷信息。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119074390_zh-CN.png)
...
9.  设置**健康检查** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119087318_zh-CN.png)
...
10. 设置**自动伸缩**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119087320_zh-CN.png)
...
12. 进入访问设置页面，您可以设置暴露后端Pod的方式，最后单击**创建**。本例中选择ClusterIP服务和路由（Ingress），构建一个可公网访问的nginx应用。 
    ...
    **说明：** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119084391_zh-CN.png)

    1.  在服务栏单击**创建**，在弹出的对话框中进行配置，最后单击**创建**。 

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119089207_zh-CN.png)
        ...
        -   **注解**：为该服务添加一个注解（annotation），支持负载均衡配置参数，参见[通过负载均衡（Server Load Balancer）访问服务](intl.zh-CN/用户指南/Kubernetes 集群/负载均衡/通过负载均衡（Server Load Balancer）访问服务.md#)。
    ...
    2.  在路由栏单击**创建**，在弹出的对话框中，为后端Pod配置路由规则，最后单击**创建**。更多详细的路由配置信息，请参见[路由配置说明](intl.zh-CN/用户指南/Kubernetes 集群/路由管理/路由配置说明.md#)。 
        ...
        **说明：** 通过镜像创建应用时，您仅能为一个服务创建路由（Ingress）。本例中使用一个虚拟主机名称作为测试域名，您需要在hosts中添加一条记录。在实际工作场景中，请使用备案域名。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119089214_zh-CN.png)

    3.  在访问设置页面，您可看到创建完毕的服务和路由，您可单击**变更**和**删除**进行二次配置，最后单击**创建**。 

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119087358_zh-CN.png)

13. 创建成功后，默认进入创建完成页面，会列出应用包含的对象，您可以单击**查看应用详情**进行查看。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119084394_zh-CN.png)

    默认进入新建的nginx-deployment的详情页面。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119084396_zh-CN.png)

14. 单击左侧导航栏的**应用** \> **路由**，可以看到路由列表下出现一条规则。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119084397_zh-CN.png)

15. 在浏览器中访问路由测试域名，您可访问 nginx 欢迎页。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6895/15338119084398_zh-CN.png)
